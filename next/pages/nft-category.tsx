...
import NftCategoryTableList from "../components/nft-category/nft-category-table-list";
import NftCategoryActionCreate from "../components/nft-category/nft-category-action-create";

const NftCategoryPage = (props: any) => {
  ...
  const getData = async ({
    ...
    NftCategoryService.getAll({
      ...
      token,
      cache: false,
      fragment: NftCategoryService.fullFragment,
    })
      .then(handleResult)
      .catch(handleError);
  };
...
NftCategoryPage.Layout = AdminLayout;
  ...
  return (
    <PageHeader>
      ...
      <PageHeaderFunctions setViewMode={setViewMode}>
        ...
        <NftCategoryActionCreate loadData={loadData} />
      </PageHeaderFunctions>
    </PageHeader>
  );
});
