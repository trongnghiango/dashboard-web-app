...
import JobTableList from "../components/job/job-table-list";
...
const JobPage = (props: any) => {
  ...
  const [data, setData] = useState<AgendaJob[]>(null);
...
const Table = ({
  ...
  return (
    <div className="bg-seconds-light pb-1">
      <TableListWrapper>
        <JobTableList data={data} loadData={loadData} viewMode={viewMode} />
      </TableListWrapper>
      <Paging
