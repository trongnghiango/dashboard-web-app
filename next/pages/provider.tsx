...
import ProviderTableList from "../components/provider/provider-table-list";
import ProviderActionCreate from "../components/provider/provider-action-create";

const ProviderPage = (props: any) => {
  ...
  const getData = async ({
    ...
    ProviderService.getAll({
      ...
      token,
      cache: false,
      fragment: ProviderService.fullFragment,
    })
      .then(handleResult)
      .catch(handleError);
  };
  ...
  return (
    <PageHeader>
      ...
      <PageHeaderFunctions setViewMode={setViewMode}>
        ...
        <ProviderActionCreate loadData={loadData} />
      </PageHeaderFunctions>
    </PageHeader>
  );
});
