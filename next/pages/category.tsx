...
import CategoryTableList from "../components/category/category-table-list";
import CategoryActionCreate from "../components/category/category-action-create";
  ...
  return (
    <PageHeader>
      ...
      <PageHeaderFunctions setViewMode={setViewMode}>
        ...
        <CategoryActionCreate loadData={loadData} />
      </PageHeaderFunctions>
    </PageHeader>
  );
});
