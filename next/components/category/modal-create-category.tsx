...
const ModalCreateCategory = ({
  ...
  const submit = (
    ...
    { setSubmitting }: FormikHelpers<CreateCategoryInput>
  ) => {
    createData({ ...values });
  ...
  const createData = (data: CreateCategoryInput) => {
    setLoading(true)(dispatch);
    const token = getUserToken(false);
    CategoryService.create({ data, token })
      .then(() => {
        loadData();
          ...
          <Form>
            <div className="p-3">
              ...
              <InputField
                ...
                // haveErrors={errors.description && touched.description}
