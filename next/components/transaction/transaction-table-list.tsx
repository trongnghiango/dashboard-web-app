...
const TransactionTableList = ({
  ...
  const columnData: ColumnData[] = [
    ...
    {
      name: TransactionArgNames.address,
      argument: TransactionArgs.address,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.string,
    },
    {
      name: TransactionArgNames.amountAther,
      argument: TransactionArgs.amountAther,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.string,
    },
    {
      name: TransactionArgNames.amountBNB,
      argument: TransactionArgs.amountBNB,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.string,
    },
    {
      name: TransactionArgNames.percentPaid,
      argument: TransactionArgs.percentPaid,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.string,
    },
    {
      name: TransactionArgNames.ratioBNB,
      argument: TransactionArgs.ratioBNB,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.string,
    },
    {
      name: TransactionArgNames.broadcastedAll,
      argument: TransactionArgs.broadcastedAll,
      display: DisplayMode.TABLE_LISTVIEW,
