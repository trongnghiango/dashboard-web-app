...
import NftCategoryActionDelete from "./nft-category-action-delete";
import NftCategoryActionUpdate from "./nft-category-action-update";
...
const NftCategoryTableList = ({
  ...
  const adminActions = [
    {
      ...
      CustomHtml: ({ data, loadData }: { data: NftCategory; loadData: () => void }) => (
        <>
          <NftCategoryActionUpdate data={data} loadData={loadData} />
          <NftCategoryActionDelete data={data} loadData={loadData} />
        </>
      ),
    },
  ...
  const columnData: ColumnData[] = [
    {
      name: NftCategoryArgNames.name,
      argument: NftCategoryArgs.name,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.string,
    },
    {
      name: NftCategoryArgNames.color,
      argument: NftCategoryArgs.color,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.string,
    },
    {
      name: NftCategoryArgNames.description,
      argument: NftCategoryArgs.description,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.string,
    },
    {
      name: NftCategoryArgNames.image,
      argument: NftCategoryArgs.image,
      display: DisplayMode.TABLE_LISTVIEW,
...
export default NftCategoryTableList;
