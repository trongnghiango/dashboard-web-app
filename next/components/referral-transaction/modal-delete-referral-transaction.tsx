...
const ModalDeleteReferralTransaction = ({
  data,
  open,
  setOpen,
  loadData,
  ...
  const confirmDelete = () => {
    ...
    const id = data.id;
    ReferralTransactionService.delete({ id, token })
      .then(() => {
        loadData();
  ...
  return (
    <AlertDialog
      ...
      onClose={closeModal}
      title="Delete referralTransaction"
      content="Are you sure you want to delete this data ?"
    />
  );
};

export default ModalDeleteReferralTransaction;
