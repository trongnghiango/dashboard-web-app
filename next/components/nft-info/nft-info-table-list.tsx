...
import { NftInfo, NftInfoArgNames, NftInfoArgs } from "../../lib/modules/nft-info/nft-info.model";
import { ColumnData, ColumnTypes, DisplayMode, ViewModes } from "../../lib/models/page.model";
import NftInfoActionDelete from "./nft-info-action-delete";
import NftInfoActionUpdate from "./nft-info-action-update";
...
const NftInfoTableList = ({
  ...
  const adminActions = [
    {
      ...
      CustomHtml: ({ data, loadData }: { data: NftInfo; loadData: () => void }) => (
        <>
          <NftInfoActionUpdate data={data} loadData={loadData} />
          <NftInfoActionDelete data={data} loadData={loadData} />
        </>
      ),
    },
  ...
  const columnData: ColumnData[] = [
    {
      name: NftInfoArgNames.name,
      argument: NftInfoArgs.name,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.string,
    },
    {
      name: NftInfoArgNames.birthDay,
      argument: NftInfoArgs.birthDay,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.date,
    },
    {
      name: NftInfoArgNames.gender,
      argument: NftInfoArgs.gender,
      display: DisplayMode.TABLE_LISTVIEW,
      type: ColumnTypes.string,
    },
    {
      name: NftInfoArgNames.mediaUrl,
      argument: NftInfoArgs.mediaUrl,
      display: DisplayMode.TABLE_LISTVIEW,
...
export default NftInfoTableList;
