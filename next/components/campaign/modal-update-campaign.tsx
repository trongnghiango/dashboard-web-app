...
const ModalUpdateCampaign = ({
  ...
  const updateData = (values: Campaign) => {
    ...
    const params: UpdateCampaignInput = {
      ...
      minimumPurchaseAtherAmount: values.minimumPurchaseAtherAmount,
      maximumPurchaseAtherAmount: values.maximumPurchaseAtherAmount,
        ...
        {({ errors, touched, values, setFieldValue }) => (
          <Form>
            <div className="p-3">
              ...
              />
              <InputField
                labelName={CampaignArgNames.minimumPurchaseAtherAmount}
                inputName={CampaignArgs.minimumPurchaseAtherAmount}
                inputType={InputType.number}
                // placeholder={`Input ${CampaignArgNames.name}`}
                // haveErrors={errors.name && touched.name}
                // error={errors.name}
              />
              <InputField
                labelName={CampaignArgNames.maximumPurchaseAtherAmount}
                inputName={CampaignArgs.maximumPurchaseAtherAmount}
                inputType={InputType.number}
                // placeholder={`Input ${CampaignArgNames.name}`}
                // haveErrors={errors.name && touched.name}
                // error={errors.name}
