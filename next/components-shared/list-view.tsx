...
import { formatDate, formatFullDayTime, formatFullTime, TIMEZONE_CODE } from "../lib/helpers/common.helper";
                ...
                (
                  ...
                  if (type === ColumnTypes.image) {
                    element = (
                      <>
                        {item[argument] && (
                          <img width={50} src={item[argument] as string} alt="img" />
                        )}
                      </>
                    );
                  }
                  ...
                  return element ? (
                    isListViewFooter ? (
                      ...
                      <Fragment key={key}>
                        <div className="font-semibold p-1 flex items-center text-primary-dark dark:text-primary">
                          {name}
                        </div>
