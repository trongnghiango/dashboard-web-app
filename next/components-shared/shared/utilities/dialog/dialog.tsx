...
export function Dialog({
  ...
  let el = (
    ...
    >
      ...
      >
        {header?.length ? (
          <div className={`dialog-header ${headerClass}`}>{header}</div>
        ) : null}
        {body?.length ? (
          <div className={`dialog-body ${bodyClass}`}>{body}</div>
        ) : null}
        {children}
        {footer?.length ? (
          <div className={`dialog-footer ${footerClass}`}>{footer}</div>
        ) : null}
      </div>
    </div>
  );
